...
class Var(object):
        ...
        def get_all_tweets(self):
                ...
                try:
                                global agreecount,opticount,negtweet,pessicount,postweet,viewholdercount,neuttweet,spectcount,specttweet,grammar
                                agreecount=0
                                opticount=0
                                negtweet=0
                                pessicount=0
                ...
                if len(threads)==0:
                    ...
                    print("Optimist:0 %")
                                ...
                                self.opti=int(100*len(ptweets)/len(threads))
                else:
                ...
                if len(nohash)==0:
                        ...
                        print("GrammarNazi:{}%".format(100*grammar/len(nohash)))
                        self.gram = int(100*grammar/len(nohash))
